...
(5,4,4,'Шторы "Льняные"','ТекстильХолдинг'),
...
(5,4,4,'Шторы "Черные"','ООО "ТекстильОпт"'),
...
(5,4,4,'Шторы "Римские"','ООО "ШторыЭкспресс"'),
...
(5,4,4,'Шторы "Жаккардовые"','Фабрика "ТекстильПремиум"'),
...
(5,4,4,'Шторы "Бархатные"','ООО "ТекстильЭлит"'),
...
(5,4,4,'Шторы "Роллетные"','ООО "ШторыСмарт"'),
...
(7,4,4,'Скакалка "SpeedRope"','ООО "ФитнесГаджетс"'),
...
(7,4,4,'Турник настенный "IronBar"','ООО "ДомашнийСпорт"'),
...
(7,4,4,'Эспандер "PowerBand"','ООО "ФитнесЛиния"'),
...
(7,4,4,'Степ-платформа "AeroStep"','ООО "АэробикаФитнес"'),
...
(7,4,4,'Палки для скандинавской ходьбы "NordicWalk"','ООО "ЗдоровьеНации"'),
...
(7,4,4,'Кистевой эспандер "PowerGrip"','ООО "СилаРуки"'),
...
(7,4,4,'Обруч хулахуп "SlimFit"','ООО "ФитнесДляВсех"'),
...
(7,4,4,'Тренажер для пресса "AbKing"','ООО "ДомашниеТренажеры"'),
...
(7,4,4,'Петли TRX "TotalBody"','ООО "ФункциональныйТренинг"'),
...
(7,4,4,'Скейтборд "StreetKing"','ООО "СкейтКомпани"'),
...
(7,4,4,'Массажный ролик "FoamRoller"','ООО "ВосстановлениеМышц"'),
...
(7,4,4,'Тренажер для спины "BackFix"','ООО "ЗдороваяСпина"'),
...
(7,4,4,'Доска для отжиманий "PushBoard"','ООО "СиловыеТренировки"'),
...
(7,4,4,'Тренажер для рук "PowerTwist"','ООО "СилаХвата"'),
...
(7,4,4,'Тренажер для ног "LegMaster"','ООО "НижнийПресс"'),
...
(7,4,4,'Тренажер для пресса "AbRoller"','ООО "КрасивыйПресс"'),
...
(7,4,4,'Тренажер для спины "PostureCorrector"','ООО "ЗдороваяОсанка"'),
...
(7,4,4,'Тренажер для рук "HandGrip"','ООО "СилаПальцев"'),
...
(7,4,4,'Тренажер для ног "LegPress"','ООО "СильныеНоги"'),
...
(7,4,4,'Тренажер для пресса "AbChair"','ООО "ДомашнийФитнес"'),
...
(7,4,4,'Тренажер для спины "BackSupport"','ООО "ЗдоровыйПозвоночник"'),
...
(7,4,4,'Тренажер для рук "FingerTrainer"','ООО "СилаПальцев"'),
...
(7,4,4,'Тренажер для ног "LegCurl"','ООО "ТренировкаНог"'),
...
(7,4,4,'Тренажер для пресса "AbWheel"','ООО "КолесоПресса"'),
...
(7,4,4,'Тренажер для спины "BackStretch"','ООО "ГибкостьСпины"'),
...
(7,4,4,'Тренажер для рук "WristRoller"','ООО "СилаЗапястья"'),
...
(7,4,4,'Тренажер для ног "LegExtension"','ООО "РазгибаниеНог"'),
...
(7,4,4,'Тренажер для пресса "AbBench"','ООО "СкамьяДляПресса"'),
...
(7,4,4,'Тренажер для спины "BackMassager"','ООО "МассажСпины"'),
...
(7,4,4,'Тренажер для рук "GripMaster"','ООО "ТренировкаХвата"'),
...
(7,4,4,'Скакалка с счетчиком "JumpCount"','ООО "ФитнесГаджеты"'),
...
(7,4,4,'Турник дверной "HomeGym"','ООО "ДомашнийТурник"'),
...
(7,4,4,'Эспандер ленточный "FlexBand"','ООО "РезиновыеТренажеры"'),
...
(7,4,4,'Степпер мини "HomeStep"','ООО "КардиоТренажеры"'),
...
(7,4,4,'Палки треккинговые "Titanium"','ООО "ГорныеПалки"'),
...
(7,4,4,'Эспандер кистевой "SteelGrip"','ООО "СтальныеТренажеры"'),
...
(7,4,4,'Обруч металлический "RetroHoop"','ООО "ВинтажныйФитнес"'),
...
(7,4,4,'Тренажер для пресса "AbKingPro"','ООО "КоролевскийПресс"'),
...
(7,4,4,'Петли для тренировок "ResistancePro"','ООО "РезистентныеПетли"'),
...
(7,4,4,'Лонгборд "SurfStyle"','ООО "ДоскиДляКатания"'),
...
(7,4,4,'Ролик массажный "DeepTissue"','ООО "ГлубокийМассаж"'),
...
(7,4,4,'Тренажер для осанки "PosturePro"','ООО "КоррекцияОсанки"'),
...
(7,4,4,'Доска для баланса "BalanceBoard"','ООО "ТренировкаРавновесия"'),
...
(7,4,4,'Тренажер для предплечий "ForearmGrip"','ООО "СилаПредплечий"'),
...
(7,4,4,'Тренажер для икр "CalfMaster"','ООО "ИкроножныеМышцы"'),
...
(7,4,4,'Тренажер для пресса "AbCrunch"','ООО "СкручиванияПресса"'),
...
(7,4,4,'Тренажер для спины "BackRelief"','ООО "РелаксСпины"'),
...
(7,4,4,'Тренажер для пальцев "FingerGrip"','ООО "СилаПальцевПро"'),
...
(7,4,4,'Тренажер для ног "LegBlaster"','ООО "ВзрывныеНоги"'),
...
(7,4,4,'Тренажер для пресса "AbSculpt"','ООО "СкульптураПресса"'),
...
(7,4,4,'Тренажер для позвоночника "SpineCare"','ООО "ЗдоровьеПозвоночника"'),
...
(7,4,4,'Тренажер для рук "GripPower"','ООО "МощныйХват"'),
...
(7,4,4,'Тренажер для ног "LegToner"','ООО "ТонусНог"'),
...
(7,4,4,'Тренажер для пресса "AbCoaster"','ООО "КачелиПресса"'),
...
(7,4,4,'Тренажер для спины "BackTherapy"','ООО "ТерапияСпины"'),
...
(7,4,4,'Тренажер для запястий "WristPower"','ООО "СилаЗапястий"'),
...
(7,4,4,'Тренажер для ног "LegPressPro"','ООО "ПрофессиональныйПресс"'),
...
(7,4,4,'Тренажер для пресса "AbKingXXL"','ООО "КорольПресса"'),
...
(7,4,4,'Тренажер для спины "BackMaster"','ООО "МастерСпины"'),
