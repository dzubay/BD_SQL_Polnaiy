...
(1,1,2,'Кефир "Простоквашино"','Компания "Юнимилк"'),
(1,1,2,'Ряженка "Брест-Литовск"','ОАО "Бабушкина крынка"'),
...
(1,1,2,'Пиво разливное "Жигулёвское"','ОАО "Жигулёвский пивоваренный завод"'),
(1,1,3,'Пиво бутылочное "Балтика 9"','ООО "Балтика"'),
(1,1,3,'Вино красное "Киндзмараули"','Импортёр "Грузинские вина"'),
(1,1,3,'Вино белое "Рислинг"','ООО "Абрау-Дюрсо"'),
(1,1,3,'Шампанское "Абрау-Дюрсо"','ООО "Абрау-Дюрсо"'),
(1,1,3,'Водка "Белуга"','ОАО "Синергия"'),
(1,1,3,'Коньяк "Арарат"','Импортёр "АрАрАт"'),
(1,1,3,'Виски "Jack Daniels"','Импортёр "Браун-Форман"'),
(1,1,3,'Ром "Bacardi"','ООО "Бакарди-Руссия"'),
(1,1,3,'Текила "Sauza"','Импортёр "Диагео"'),
(1,1,3,'Ликер "Baileys"','ООО "Диагео Рус"'),
(1,1,3,'Настойка "Бехеровка"','Импортёр "Перно Рикар"'),
(1,1,3,'Сидр "Strongbow"','ООО "Хайнекен"'),
...
(1,1,2,'Сок "Добрый"','ООО "Мултон"'),
(1,1,2,'Нектар "Rich"','ОАО "Лебедянский"'),
(1,1,2,'Морс "Брусничный"','ООО "Ягодные традиции"'),
(1,1,2,'Компот "Вишневый"','ООО "ФрутСтайл"'),
(1,1,3,'Минеральная вода "Ессентуки"','ОАО "Нарзан"'),
(1,1,2,'Газировка "Буратино"','ООО "Дека"'),
(1,1,2,'Лимонад "Тархун"','ОАО "Очаково"'),
(1,1,2,'Квас "Очаковский"','ОАО "Очаково"'),
...
(1,1,3,'Сок детский "Агуша"','ООО "Вимм-Билль-Данн"'),
...
(9,1,2,'Охлаждающая жидкость "Sintec"','ЗАО "Обнинскоргсинтез"'),
...
(15,1,2,'Шампунь для животных "Пушистик"','ООО "ВетКосметикс"'),
...
(15,1,2,'Кондиционер для шерсти "Шёлк"','ООО "ВетКосметикс"'),
...
(15,1,2,'Спрей от блох "АнтиПаразит"','ООО "ВетКосметикс"'),
...
(15,1,2,'Шампунь от перхоти "Чистая Шерсть"','ООО "ВетКосметикс"'),
...
(15,1,2,'Кондиционер-антистатик "Бархат"','ООО "ВетКосметикс"'),
...
(15,1,2,'Спрей для ушей "Чистые Ушки"','ООО "ВетКосметикс"'),
...
(15,1,2,'Шампунь гипоаллергенный "Нежность"','ООО "ВетКосметикс"'),
...
(15,1,2,'Спрей для лап "Зимний Уход"','ООО "ВетКосметикс"'),
...
(15,1,2,'Кондиционер от колтунов "Распутайка"','ООО "ВетКосметикс"'),
...
(15,1,2,'Шампунь от запаха "Свежесть"','ООО "ВетКосметикс"'),
...
(15,1,2,'Спрей для зубов "Свежее Дыхание"','ООО "ВетКосметикс"'),
...
(15,1,2,'Шампунь лечебный "Доктор"','ООО "ВетКосметикс"'),
