...
--При создании полнотекстового индекса, должен быть обязательно создан кластерный уникальный или некластерный уникальный индекс
--который будет ссылаться на один только столбец

--С партициями можно сделать тогда когда схеме будет указан один столбец, и только по идентификатору уникальному, который потом можно указать для
--полнотекстового индекса. Иначе никак!!!!
