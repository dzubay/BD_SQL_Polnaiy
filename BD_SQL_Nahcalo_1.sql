...
declare                                          --------------------------------------------
 @Magaz_DB_2_Root      nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Magaz_DB_2_Root\'   +  'Magaz_DB_2_Root.mdf'      -- Папка для  Magaz_DB_2_Root
,@Customers_Data_2_1   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Costomers_Group_2\' +  'Customers_Data_2_1.ndf'   -- Одна папка для двух файлов
,@Customers_Data_2_2   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Costomers_Group_2\' +  'Customers_Data_2_2.ndf'   --     Costomers_Group_2
,@Product_Data_2_1	   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Products_Group_2\'  +  'Product_Data_2_1.ndf'     -- Одна папка для двух файлов
,@Product_Data_2_2	   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Products_Group_2\'  +  'Product_Data_2_2.ndf'	 --     Products_Group_2
,@Orders_Data_2_1	   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Orders_Group_2\'    +  'Orders_Data_2_1.ndf'      -- Одна папка для двух файлов
,@Orders_Data_2_2	   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Orders_Group_2\'    +  'Orders_Data_2_2.ndf'		 --     Orders_Group_2
,@Employee_Data_2_1	   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Employee_Group_2\'  +  'Employee_Data_2_1.ndf'    -- Одна папка для двух файлов
,@Employee_Data_2_2	   nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Employee_Group_2\'  +  'Employee_Data_2_2.ndf'	 --     Employee_Group_2
,@Log_Data_2           nvarchar(400) =  'd:\Программы\БД\Моя база данных\2024\Более новая БД\Файлы_БД_полной\Log_Data_2\'        +  'Log_Data_2.ldf'           -- Папка для  Log_Data_2
                                         --------------------------------------------    
